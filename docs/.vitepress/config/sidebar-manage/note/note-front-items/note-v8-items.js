...
module.exports = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "5", link: `${baseUrl}/v8-note-16` },
      { text: "5", link: `${baseUrl}/v8-note-17` },
    ],
  },
  {
    text: "事件循环和垃圾回收",
    items: [
      { text: "5", link: `${baseUrl}/v8-note-18` },
      { text: "5", link: `${baseUrl}/v8-note-19` },
      { text: "5", link: `${baseUrl}/v8-note-20` },
      { text: "5", link: `${baseUrl}/v8-note-21` },
      { text: "5", link: `${baseUrl}/v8-note-22` },
      { text: "5", link: `${baseUrl}/v8-note-23` },
    ],
  },
];
