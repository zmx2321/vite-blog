...
const siteData = [
  {
    ...
    items: [
      ...
      },
      {
        icon: "",
        name: "Nuxt.js",
        desc: "Nuxt.js 是一个基于 Vue.js 的轻量级应用框架,可用来创建服务端渲染 (SSR) 应用,也可充当静态站点引擎生成静态站点应用,具有优雅的代码结构分层和热加载等特性",
        link: "https://www.nuxtjs.cn/"
      },
      {
        icon: "",
        name: "VueUse",
        desc: "基于Vue组合式API的实用工具集",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "",
        name: "Redux Toolkit",
        desc: "Redux 官方强烈推荐，开箱即用的一个高效的 Redux 开发工具集。它旨在成为标准的 Redux 逻辑开发模式，我们强烈建议你使用",
        link: "https://cn.redux.js.org/"
      },
      {
        icon: "",
      ...
      },
      {
        icon: "",
        name: "dvajs",
        desc: "dva 首先是一个基于 redux 和 redux-saga 的数据流方案",
...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"pageClass":"site-layout"},"headers":[],"relativePath":"pages/site/framework.md","filePath":"pages/site/framework.md","lastUpdated":1698303382000}');
const __default__ = { name: "pages/site/framework.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/site/framework.md");
