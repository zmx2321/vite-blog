...
- 我们平时所说的Ubuntu、CentOS那些是指发行版，linux内核只是拥有最基本的功能，它本身有六大系统，这六大系统就组成了操作系统核心的功能。
...
<br />
> &nbsp;&nbsp; _b. 网络适配器：
配置网络的时候不要使用NAT，否则网络环境就会非常复杂了，它会给你自动配置一个虚拟的局域网来，处理事情的时候会产生一些干扰。推荐使用桥接模式。但使用桥接模式，必须要保证网络的畅通，一旦把网络断开，桥接就会失效_
<br />
> &nbsp;&nbsp; _c. 专门的网络管理：
