import{_ as s,o as n,c as a,e as l}from"./app.d5d3d1ad.js";const u=JSON.parse('{"title":"openlayer库完整代码","description":"","frontmatter":{},"headers":[],"relativePath":"pages/note/front/gis-note/openlayer-note-5.md","filePath":"pages/note/front/gis-note/openlayer-note-5.md","lastUpdated":1716862823000}'),p={name:"pages/note/front/gis-note/openlayer-note-5.md"},o=l(`<h1 id="openlayer库完整代码" tabindex="-1">openlayer库完整代码 <a class="header-anchor" href="#openlayer库完整代码" aria-label="Permalink to &quot;openlayer库完整代码&quot;">​</a></h1><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// map core</span></span>
