import{_ as n,o as a,c as l,a as p}from"./app.4033c713.js";const F=JSON.parse('{"title":"mapbox工作积累","description":"","frontmatter":{},"headers":[],"relativePath":"pages/note/front/gis-note/mapbox-note-1.md","filePath":"pages/note/front/gis-note/mapbox-note-1.md","lastUpdated":1716969580000}'),o={name:"pages/note/front/gis-note/mapbox-note-1.md"};function e(c,s,r,t,E,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="mapbox工作积累" tabindex="-1">mapbox工作积累 <a class="header-anchor" href="#mapbox工作积累" aria-label="Permalink to &quot;mapbox工作积累&quot;">​</a></h1><h2 id="重置地图" tabindex="-1">重置地图 <a class="header-anchor" href="#重置地图" aria-label="Permalink to &quot;重置地图&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 移除所有标注</span></span>
