import{_ as s,o as n,c as a,e as p}from"./app.80056c26.js";const d=JSON.parse('{"title":"css高级用法","description":"","frontmatter":{},"headers":[],"relativePath":"pages/note/front/css-note/css-note-2.md","filePath":"pages/note/front/css-note/css-note-2.md","lastUpdated":1702954749000}'),l={name:"pages/note/front/css-note/css-note-2.md"},o=p(`<h1 id="css高级用法" tabindex="-1">css高级用法 <a class="header-anchor" href="#css高级用法" aria-label="Permalink to &quot;css高级用法&quot;">​</a></h1><h2 id="css计算" tabindex="-1">css计算 <a class="header-anchor" href="#css计算" aria-label="Permalink to &quot;css计算&quot;">​</a></h2><div class="language-css vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">// 输入框宽度</span></span>
