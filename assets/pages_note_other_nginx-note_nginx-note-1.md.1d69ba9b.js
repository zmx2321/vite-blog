import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.e9710eb2.js";const F=JSON.parse('{"title":"nginx相关笔记","description":"","frontmatter":{},"headers":[],"relativePath":"pages/note/other/nginx-note/nginx-note-1.md","filePath":"pages/note/other/nginx-note/nginx-note-1.md","lastUpdated":1700105199000}'),p={name:"pages/note/other/nginx-note/nginx-note-1.md"},e=l(`<h1 id="nginx相关笔记" tabindex="-1">nginx相关笔记 <a class="header-anchor" href="#nginx相关笔记" aria-label="Permalink to &quot;nginx相关笔记&quot;">​</a></h1><h2 id="_1-vue项目中使用proxy之后-在nginx中如何代理" tabindex="-1">1. vue项目中使用proxy之后，在nginx中如何代理 <a class="header-anchor" href="#_1-vue项目中使用proxy之后-在nginx中如何代理" aria-label="Permalink to &quot;1. vue项目中使用proxy之后，在nginx中如何代理&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">server {</span></span>
