import{_ as e,C as s,o,c,H as n,w as r,k as a,a as t,Q as E}from"./chunks/framework.e9710eb2.js";const R=JSON.parse('{"title":"mysql笔记整理","description":"","frontmatter":{},"headers":[],"relativePath":"pages/note/back/mysql-note/mysql-note-1.md","filePath":"pages/note/back/mysql-note/mysql-note-1.md","lastUpdated":1700105199000}'),y={name:"pages/note/back/mysql-note/mysql-note-1.md"},i=a("h1",{id:"mysql笔记整理",tabindex:"-1"},[t("mysql笔记整理 "),a("a",{class:"header-anchor",href:"#mysql笔记整理","aria-label":'Permalink to "mysql笔记整理"'},"​")],-1),A=E(`<blockquote><p>注释内容在navicat中皆可直接运行，需要先直接运行查询内容，创建表结构之后，之后可以选择任意具体的语句直接运行，经过测试，里面的增删改查，多表查询，复杂条件查询等都可运行成功。</p></blockquote><div class="language-sql vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sql</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#6A737D;">-- 如果存在，删除</span></span>
