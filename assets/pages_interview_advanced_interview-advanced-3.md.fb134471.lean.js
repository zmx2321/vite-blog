import{_ as n,o as a,c as l,a as e}from"./app.2afc42a8.js";const b=JSON.parse('{"title":"知识-属性描述符","description":"","frontmatter":{},"headers":[],"relativePath":"pages/interview/advanced/interview-advanced-3.md","filePath":"pages/interview/advanced/interview-advanced-3.md","lastUpdated":1742435983000}'),p={name:"pages/interview/advanced/interview-advanced-3.md"};function o(c,s,r,t,i,y){return a(),l("div",null,s[0]||(s[0]=[e(`<h1 id="知识-属性描述符" tabindex="-1">知识-属性描述符 <a class="header-anchor" href="#知识-属性描述符" aria-label="Permalink to &quot;知识-属性描述符&quot;">​</a></h1><h2 id="基本概念" tabindex="-1">基本概念 <a class="header-anchor" href="#基本概念" aria-label="Permalink to &quot;基本概念&quot;">​</a></h2><ul><li>属性描述符：用来描述对象属性的特性</li><li>数据描述符：包含<code>value</code>、<code>writable</code>、<code>configurable</code>、<code>enumerable</code>四个属性</li></ul><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">obj</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
